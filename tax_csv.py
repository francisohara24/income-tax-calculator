...
"""
import taxer   # import tax calculator function
...
for line in fh_input:
    ...
    tax, net = taxer.calculate(float(salary))  # calculate tax and net income and store results in variables tax and net
